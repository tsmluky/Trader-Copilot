...
export const RegisterPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white selection:bg-gold-500/30 overflow-x-hidden font-sans relative">
            ...
            {/* Background Texture & Lighting (Matching Login) */}
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute inset-0 bg-grid opacity-20" />
                <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-brand-900/20 rounded-full blur-[120px] mix-blend-screen opacity-40"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-gold-500/5 blur-[120px] rounded-full mix-blend-screen opacity-30"></div>
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 lg:py-0 flex flex-col lg:flex-row items-center justify-between min-h-screen gap-12 lg:gap-24">
                ...
                <div className="hidden lg:block flex-1 space-y-8 animate-in slide-in-from-bottom-5 duration-700">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-bold tracking-tight leading-[1.1]">
                        Unlock <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-orange-500">Pro-Grade</span> <br />
                        Analytics.
                    </h1>
                ...
                {/* Right: Register Card */}
                <div className="w-full max-w-md animate-in slide-in-from-bottom-10 duration-1000 delay-200 mx-auto">

                    <div className="relative group">
                        {/* Glow Effect */}
                        <div className="absolute -inset-0.5 bg-gradient-to-br from-brand-500/20 to-gold-500/20 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-1000"></div>
                        ...
                        <div className="relative glass-card rounded-2xl p-8 shadow-2xl border border-white/10 bg-[#0f172a]/80">
                            ...
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-slate-400 text-xs mt-1 font-mono uppercase tracking-wide">Start your journey today</p>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative group/input">
                                        <User className="absolute left-3.5 top-3.5 text-slate-500 group-focus-within/input:text-gold-400 transition-colors" size={18} />
                                        <input
                                            type="text"
                                            value={name}
                                ...
                                {error && (
                                    <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 text-xs font-medium flex items-center gap-2 font-mono justify-center">
                                        <AlertCircle size={14} />
                                        {error}
                                    </div>
                                )}
                                ...
                                <div className="text-center pt-2">
                                    <Link to="/login" className="text-xs text-slate-400 hover:text-gold-400 transition-colors">
