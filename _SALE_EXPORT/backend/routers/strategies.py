...
async def get_marketplace(
    ...
    for c in configs:
        ...
        personas.append({
            ...
            "win_rate": f"{int(c.win_rate)}%" if c.win_rate is not None else "N/A", # Formatted
...
async def delete_persona(
    ...
    deleted_signals = db.query(Signal).filter(Signal.source == target_source).delete()
    ...
    print(f"🗑️ Deleting Persona {persona_id}: Metadata + {deleted_signals} Signals.")
